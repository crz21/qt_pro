/****************************************************************************
** Meta object code from reading C++ file 'video_recorder.h'
**
...
#error "The header file 'video_recorder.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 14, 15), // "onFrameReceived"
QT_MOC_LITERAL(2, 30, 0), // ""
QT_MOC_LITERAL(3, 31, 5) // "frame"

    },
    "VideoRecorder\0onFrameReceived\0\0frame"
};
...
void VideoRecorder::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->onFrameReceived((*reinterpret_cast< const QImage(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
QT_INIT_METAOBJECT const QMetaObject VideoRecorder::staticMetaObject = { {
    ...
    qt_meta_stringdata_VideoRecorder.data,
    qt_meta_data_VideoRecorder,
    qt_static_metacall,
    nullptr,
    nullptr
} };
